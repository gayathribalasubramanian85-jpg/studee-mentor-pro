...
export default function PlacementSettings() {
  ...
  const handleSavePassword = async () => {
    ...
    setChanging(true);
    try {
      await placementApi.changePassword({
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="ml-0 lg:ml-64">
        <DashboardHeader title="Settings" userName={`${currentUser?.name || 'Placement'} Officer`} />
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input value={currentUser?.department || 'Placement'} disabled className="bg-muted" />
                </div>
                <div className="space-y-2">
                  <Label>Role</Label>
                  <Input value="Placement Officer" disabled className="bg-muted" />
                </div>
              </div>
            </CardContent>
          </Card>
